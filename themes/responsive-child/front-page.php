...
if ( 'posts' == get_option( 'show_on_front' ) && $responsive_options['front_page'] != 1 ) {
	...
	<div id="featured" class="grid col-940">
		...
		<div id="featured-content" class="grid col-460">
		   ...
		   <p>
		      <?php _e( 'Webbsidan är inte klar! Webbsidan ska bli en enkel webbsida som kan räkna kalorier.', 'responsive-child' ); ?>
		   </p>

		   <img class="aligncenter" src="<?php echo( get_stylesheet_directory_uri() . '/images/construction.png' ); ?>" alt="" height="100" width="240" />

 ...
 */
define('__ROOTsearchsitemhandler__', dirname(dirname(__FILE__)));
define('__MODELsearchsitemhandler__', dirname(dirname(dirname(__FILE__))));

require_once(__MODELsearchsitemhandler__.'/model/Security.php');
require_once(__MODELsearchsitemhandler__.'/model/Log.php');
...
try {
	...
	$fileName  = __ROOTsearchsitemhandler__ . '/controller/' . $className . '.php';
